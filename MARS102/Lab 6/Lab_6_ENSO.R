...
ggplot()+
  #setting the color iof the background to white (instead of gray)
  theme_bw() +
  ...
  annotate("text",x=dt[400], y=2.5, label= "EL NINO", color = "red", size=12)+
  annotate("text",x=dt[400], y=-2.3, label= "LA NINA", color = "blue", size=12)+
